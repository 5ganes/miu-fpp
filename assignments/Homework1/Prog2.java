...
public class Prog2 {
    public static void main(String[] args){
        String records = "231A,Light Bulb,123,Wilco,1.75:"+
                ...
                "215A,Hair Ball,0,Little Jimmy,0.00:"; // list of records in a single string

        String[] recordsList = records.split(":"); // converting record list string into an array of records
        for (String record : recordsList){ // loop to get single record
            String[] recordSingle = record.split(","); // convert single record into an array of fields
            System.out.println(recordSingle[0]); // display first value(productId)
        }
